...
<div class="form-container">
    ...
    <form action="add-reservation" method="post">
        ...
        <input type="tel" name="phone" placeholder="Phone Number (e.g., 0771234567)" required><br>
        ...
        <label for="check_in_date" style="color: #555; font-size: 14px;">Check-In Date</label>
        <input type="date" name="check_in_date" id="check_in_date" required><br>
        
        <label for="check_out_date" style="color: #555; font-size: 14px;">Check-Out Date</label>
